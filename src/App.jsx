      ...
      <main className="ml-[20%] w-4/5 p-12 lg:p-20 xl:max-w-6xl">
        ...
        <section id="intro" className="mb-24">
          ...
          <p className="text-lg text-zinc-400 leading-relaxed mb-8 max-w-3xl">
            ...
            <br/><br/>
            L'objectif est de démontrer non seulement l'application d'algorithmes mathématiques complexes, mais aussi leur mise en œuvre technique et visuelle.
          </p>
        </section>
        ...
        <section id="tp5" className="mb-24 scroll-mt-20">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 lg:p-8 mb-8">
            ...
            <div className="bg-zinc-950 p-4 rounded-xl border border-zinc-800 font-mono text-sm text-zinc-500 mb-6 flex items-center justify-center">
              ...
              @import "tailwindcss"; J(u) = \int_{\Omega} |\nabla u| dx + \frac{\lambda}{2} \int_{\Omega} (u - u_0)^2 dx @import "tailwindcss";
            </div>
            <p className="text-zinc-400 mb-6">
              Ici, vous pourrez insérer l'explication du rôle du paramètre lambda (?) dans le compromis entre l'attache aux données et la régularisation géographique de l'image.
            </p>
            ...
            <div className="bg-zinc-800/30 rounded-xl p-6 border border-zinc-800/50">
              ...
              <div className="bg-zinc-950 p-4 rounded-lg text-sm text-zinc-400 border border-zinc-800">
                {lambda < 30 ? (
                  ...
                  <span className="text-blue-400">Mode Variation Totale forte : Fort lissage, effet "rapiéçage", l'image perd des détails fins.</span>
                ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-sm text-zinc-500 italic">
                Insérer ici l'analyse sur l'évolution de la courbe et la résolution de l'équation d'Euler-Lagrange.
              </div>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex flex-col items-center justify-center min-h-[300px] relative overflow-hidden group">
              ...
              <p className="text-xs text-zinc-600 mt-2 text-center px-4">
                Importer ici le rendu React (ou image gif) simulant l'évolution des itérations du contour actif.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="tp10" className="mb-24 scroll-mt-20">
          ...
          <p className="text-zinc-400 mb-8 max-w-3xl leading-relaxed">
            L'analyse du signal audio par la Transformée de Fourier à Court Terme (TFCT) nous permet d'obtenir un spectrogramme. Ici, nous l'utilisons pour illustrer la compression temporelle (Phase Vocoder) sans altération de la hauteur de note.
          </p>
        ...
        <section id="tp11" className="mb-24 scroll-mt-20">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 mb-8">
            <p className="text-zinc-400 mb-6 leading-relaxed">
              L'algorithme de Shazam repose sur la création de "constellations" de pics spectraux, regroupés en triplets de 32 bits (fréquence f1, fréquence f2, et délai). Dans cette section, j'évalue la robustesse de l'algorithme face à différents niveaux de rapport signal-sur-bruit (SNR).
            </p>
        ...
        <footer className="w-full pt-8 pb-12 border-t border-zinc-800 flex justify-between items-center text-sm text-zinc-500">
          <p>© 2026 - Rapport de l'UE Traitement des Données Audiovisuelles</p>
          <p>Propulsé par React, Vite et TailwindCSS</p>
        </footer>
